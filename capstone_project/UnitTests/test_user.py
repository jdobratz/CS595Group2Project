...
class TestUser(TestCase):
    ...
    def test_get_user_by_username(self):
        ...
        self.assertEqual(self.username1, user.username, msg='Login ID should be equal to user1s login id.')
    ...
    def test_empty_username(self):
        ...
        self.assertTrue(user.username, msg='Login ID can not be empty')
